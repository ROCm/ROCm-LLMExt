...
* [llama.cpp](https://rocm.docs.amd.com/projects/llama-cpp/en/docs-25.08/) is an open-source inference library and framework for large language model (LLM) inference that runs on both central processing units (CPUs) and graphics processing units (GPUs). It is written in plain C/C++, providing a simple, dependency-free setup.
...
* [verl](https://rocm.docs.amd.com/projects/verl/en/docs-25.08/) is a flexible, efficient and production-ready RL training library designed for large language models (LLMs) post-training.
