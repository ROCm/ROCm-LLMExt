...
.. table::
   ...
   +======================+==============================================+==================+==============+========+====================+================+====================================+
   | 26.02                | `FlashInfer 0.2.5                            | MI325X,          | 7.1.1        | 24.04  | 2.8.0              | 3.12.9         | |docker-icon| `rocm/flashinfer     |
   ...
   +----------------------+----------------------------------------------+------------------+--------------+--------+--------------------+----------------+------------------------------------+
   | 25.09                | `FlashInfer 0.2.5                            | MI300X           | 6.4.1        | 24.04  | 2.7.1              | 3.12.9         | |docker-icon| `rocm/flashinfer     |
   |                      | <https://rocm.docs.amd.com/projects/         |                  |              |        |                    |                | <https://hub.docker.com/r/rocm/    |
   ...
   +----------------------+----------------------------------------------+------------------+--------------+--------+--------------------+----------------+------------------------------------+
   | 25.08                | `Ray 2.48.0.post0                            | MI300X,          | 6.4.1        | 24.04  | 2.6.0+git684f6f2   | 3.12.10        | |docker-icon| `rocm/ray            |
