...
+======================+========+==============+================+====================+==================+==============================================+====================================+
| 26.02                | 24.04  | 7.1.1        | 3.12.9         | 2.8.0              | MI325X,          | `FlashInfer 0.2.5                            | `rocm/flashinfer                   |
...
+                      +--------+--------------+----------------+--------------------+------------------+----------------------------------------------+------------------------------------+
|                      | 22.04  | 7.0.0        | 3.12.12        | 2.9.0a0+git1c57644 | MI300X           | `Ray 2.51.1                                  | `rocm/ray                          |
|                      |        |              |                |                    |                  | <https://rocm.docs.amd.com/projects/         | <https://hub.docker.com/r/rocm/    |
|                      |        |              |                |                    |                  | ray/en/docs-26.02/install/                   | ray/tags?name=ray-2.51>`__         |
|                      |        |              |                |                    |                  | ray-install.html>`__                         |                                    |
+                      +--------+--------------+----------------+--------------------+------------------+----------------------------------------------+------------------------------------+
|                      | 22.04  | 7.0.0        | 3.12.11        | 2.9.0              | MI300X           | `verl 0.6.0                                  | `rocm/verl                         |
|                      |        |              |                |                    |                  | <https://rocm.docs.amd.com/projects/         | <https://hub.docker.com/r/rocm/    |
|                      |        |              |                |                    |                  | verl/en/docs-26.02/install/                  | verl/tags?name=                    |
|                      |        |              |                |                    |                  | verl-install.html>`__                        | name=verl-0.6.0>`__                |
+                      +--------+--------------+----------------+--------------------+------------------+----------------------------------------------+------------------------------------+
|                      | 24.04, | 7.0.0        | N/A            | N/A                | MI325X,          | `llama.cpp b6652                             | `rocm/llama.cpp                    |
|                      | 22.04  |              |                |                    | MI300X,          | <https://rocm.docs.amd.com/projects/         | <https://hub.docker.com/r/rocm/    |
|                      |        |              |                |                    | MI210            | llama-cpp/en/docs-26.02/install/             | llama.cpp/tags?name=               |
|                      |        |              |                |                    |                  | llama-cpp-install.html>`__                   | llama.cpp-b6652.amd0>`__           |
+----------------------+--------+--------------+----------------+--------------------+------------------+----------------------------------------------+------------------------------------+
| 25.09                | 24.04  | 6.4.1        | 3.12.9         | 2.7.1              | MI300X           | `FlashInfer 0.2.5                            | `rocm/flashinfer                   |
|                      |        |              |                |                    |                  | <https://rocm.docs.amd.com/projects/         | <https://hub.docker.com/r/rocm/    |
|                      |        |              |                |                    |                  | flashinfer/en/docs-25.09/install/            | flashinfer/tags?name=              |
|                      |        |              |                |                    |                  | flashinfer-install.html>`__                  | flashinfer-0.2.5_rocm6>`__         |
+                      +--------+--------------+----------------+--------------------+------------------+----------------------------------------------+------------------------------------+
|                      | 24.04, | 7.0.0,       | N/A            | N/A                | MI325X,          | `llama.cpp b6356                             | `rocm/llama.cpp                    |
