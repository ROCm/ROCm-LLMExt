...
* verl on ROCm - `Installation instructions <https://rocm.docs.amd.com/projects/verl/en/docs-25.08/install/verl-install.html>`__
...
* Ray on ROCm - `Installation instructions <https://rocm.docs.amd.com/projects/ray/en/docs-25.08/install/ray-install.html>`__
* llama.cpp on ROCm - `Installation instructions <https://rocm.docs.amd.com/projects/llama-cpp/en/docs-25.09/install/llama-cpp-install.html>`__
* FlashInfer on ROCm - `Installation instructions <https://rocm.docs.amd.com/projects/flashinfer/en/docs-25.09/install/flashinfer-install.html>`__