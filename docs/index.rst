...
.. note::
   ...
   ROCm-LLMExt 25.09 includes targeted updates to one component (llama.cpp) and introduces another (FlashInfer);
   four components remain unchanged (verl, Stanford Megatron-LM, Megablocks, and Ray).
...
.. grid:: 2
  ...
  .. grid-item-card:: Components
    ...
    * `FlashInfer <https://rocm.docs.amd.com/projects/flashinfer/en/docs-25.09/>`__
    * `llama.cpp <https://rocm.docs.amd.com/projects/llama-cpp/en/docs-25.09/>`__
  ...
  .. grid-item-card:: Resources
    ...
    * `llama.cpp on ROCm blog <https://rocm.blogs.amd.com/artificial-intelligence/coding-agent/README.html>`__
